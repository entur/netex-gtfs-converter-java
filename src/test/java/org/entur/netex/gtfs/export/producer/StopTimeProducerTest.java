...
class StopTimeProducerTest {
  ...
  private static final String TEST_STOP_POINT_IN_JOURNEY_PATTERN_ID_1 =
    "ENT:StopPointInJourneyPattern:1";
  private static final String TEST_SCHEDULED_STOP_POINT_ID_1 =
  ...
  void testStopTime() {
    ...
    StopTimeProducer stopTimeProducer = new DefaultStopTimeProducer(
      netexDatasetRepository,
      gtfsDatasetRepository
    );

    TimetabledPassingTime timetabledPassingTime =
      createTestTimetabledPassingTime(
        TEST_STOP_POINT_IN_JOURNEY_PATTERN_ID_1,
        TEST_ARRIVAL_TIME
      );
    JourneyPattern journeyPattern = createTestJourneyPattern(
      TEST_SCHEDULED_STOP_POINT_ID_1,
      TEST_STOP_POINT_IN_JOURNEY_PATTERN_ID_1
    );
    Trip trip = new Trip();
  ...
  private JourneyPattern createTestJourneyPattern(
    ...
    return createTestJourneyPattern(
  ...
  private JourneyPattern createTestJourneyPattern(
    ...
    StopPointInJourneyPattern stopPointInJourneyPattern =
      NETEX_FACTORY.createStopPointInJourneyPattern();
    ...
    PointsInJourneyPattern_RelStructure pointsInSequence =
      NETEX_FACTORY.createPointsInJourneyPattern_RelStructure();
    pointsInSequence
  ...
  private TimetabledPassingTime createTestTimetabledPassingTime(
    String stopPointInJourneyPatternRef,
    LocalTime arrivalTime
  ) {
    return createTestTimetabledPassingTime(
  ...
  private TimetabledPassingTime createTestTimetabledPassingTime(
    ...
    TimetabledPassingTime timetabledPassingTime =
      NETEX_FACTORY.createTimetabledPassingTime();
    ...
    StopPointInJourneyPatternRefStructure stopPointInJourneyPatternRefStructure =
      NETEX_FACTORY.createStopPointInJourneyPatternRefStructure();
    ...
    JAXBElement<? extends PointInJourneyPatternRefStructure> pointInJourneyPatternRef =
      NETEX_FACTORY.createStopPointInJourneyPatternRef(
