...
class TransferProducerTest {
    ...
    void testTransferProducer() {
        ...
        ServiceJourneyInterchange serviceJourneyInterchange = createTestServiceJourneyInterchange(TEST_SERVICE_JOURNEY_FROM_ID, TEST_SERVICE_JOURNEY_TO_ID, TEST_SCHEDULED_STOP_POINT_FROM_ID, TEST_SCHEDULED_STOP_POINT_TO_ID);
