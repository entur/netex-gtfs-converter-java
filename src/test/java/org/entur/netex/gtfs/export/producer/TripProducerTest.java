...
class TripProducerTest {
    ...
    private static final String TEST_DATED_SERVICE_JOURNEY_ID = "ENT:DatedServiceJourney:1";
    ...
    void testTripProducer() {
        ...
        ServiceJourney serviceJourney = createTestServiceJourney(TEST_SERVICE_JOURNEY_ID, TEST_DAY_TYPE_ID);
    ...
    void testTripProducerWithDatedServiceJourney() {
        ...
        ServiceJourney serviceJourney = createTestServiceJourney(TEST_SERVICE_JOURNEY_ID, null);
        ...
        DatedServiceJourney datedServiceJourney = createTestDatedServiceJourney(TEST_SERVICE_JOURNEY_ID, TEST_OPERATING_DAY_ID);
        ...
        when(netexDatasetRepository.getDayTypeById(TEST_DAY_TYPE_ID)).thenReturn(dayType);
        when(netexDatasetRepository.getDatedServiceJourneysByServiceJourneyId(TEST_SERVICE_JOURNEY_ID)).thenReturn(Set.of(datedServiceJourney));
        when(netexDatasetRepository.getOperatingDayById(TEST_OPERATING_DAY_ID)).thenReturn(operatingDay);
    ...
    private ServiceJourney createTestServiceJourney(String serviceJourneyId, String dayTypeId) {
    ...
    private DatedServiceJourney createTestDatedServiceJourney(String serviceJourneyId, String operatingDayId) {
        DatedServiceJourney datedServiceJourney = NETEX_FACTORY.createDatedServiceJourney();
        datedServiceJourney.setId(TEST_DATED_SERVICE_JOURNEY_ID);

        ServiceJourneyRefStructure serviceJourneyRefStructure = NETEX_FACTORY.createServiceJourneyRefStructure();
        serviceJourneyRefStructure.setRef(serviceJourneyId);
        JAXBElement<ServiceJourneyRefStructure> serviceJourneyRef = NETEX_FACTORY.createServiceJourneyRef(serviceJourneyRefStructure);
