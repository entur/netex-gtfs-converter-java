...
public class TimetablesToGtfsConverter {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(
    TimetablesToGtfsConverter.class
  );
  ...
  public TimetablesToGtfsConverter(
  ...
  public void convertStops() {
    ...
    Set<String> allQuaysId = netexDatasetRepository
      .getServiceJourneys()
      .stream()
   ...
   */
  public boolean isValidServiceJourneyInterchange(
